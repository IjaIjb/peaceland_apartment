      ...
      <div className="h-full  pb-20 object-cover w-full ">
       ...
       Personal Shoppers
            ...
            <div className="grid lg:grid-cols-4 grid-cols-2 gap-2 z-10">
              <Link to="/catalog/personal-shopper/kwickmall">
                <img
                  src="/images/kwickmall shopper.png"
                  alt="location"
              ...
              <Link to="/catalog/personal-shopper/kaybee">
                <img
                  src="/images/Kaybee luxury personal shopper.png"
                  alt="location"
                  className="rounded-md"
                />
                <h4 className="text-[12px] text-center uppercase">
                Kaybee luxury personal shopper
                </h4>
              </Link>
            </div>
...
export default PersonalShopperHome
